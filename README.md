# Project_4
project_4 implementation
link to x-ray data set https://drive.google.com/file/d/1c3UVEdCWQLfY_cgiljsFFAAIPtvTi0Q9/view?usp=drive_link
data on main:
Trained_xray_model : baseline xray model
Trained_fashion_model: baseline fashion model
